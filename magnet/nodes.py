...
class Conv(MonoNode):
    def __init__(self, *args, **kwargs):
        self.configuration = {'c': None, 'k': 3, 'p': 'half', 's': 1, 'd': 1, 'g': 1, 'b': True, 'ic': None, 'dims': None, 'act': 'relu'}
        super().__init__(*args, **kwargs)
...
class Linear(MonoNode):
    def __init__(self, *args, **kwargs):
        self.configuration = {'o': None, 'b': True, 'act': 'relu', 'flat': True, 'i': None, 'act': 'relu'}
        super().__init__(*args, **kwargs)
